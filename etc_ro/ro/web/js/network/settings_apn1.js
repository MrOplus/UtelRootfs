...
function($, ko, config, service, _) {
	...
	function APNViewModel(){
		...
		self.filterApn = ko.observable(apnSettings.tz_apn2_enable);
		self.defApn = ko.observable(apnSettings.apn2_profile_name);//当前APN
		self.selectedPdpType = ko.observable(apnSettings.apn2_type);
		self.apn = ko.observable(apnSettings.apn2_wan);
		self.username = ko.observable(apnSettings.apn2_username);
		self.password = ko.observable(apnSettings.apn2_passwd);
		self.selectedAuthentication = ko.observable(apnSettings.apn2_auth_mode);
		self.isConnectStatus = ko.observable(!isConnectedNetWork());
		self.profileName = ko.observable(apnSettings.apn2_profile_name);
        ...
        if(apnSettings.tz_apn2_enable == 0){
        ...
        self.doConnect = function () {
         ...
         self.saveAct = function(){
                ...
                service.addOrEditApn2(params, function(result) {
