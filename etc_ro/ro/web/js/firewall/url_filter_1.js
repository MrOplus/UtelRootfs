...
define(['jquery', 'knockout', 'config/config', 'service', 'underscore'],
    ...
    function ($, ko, config, service, _) {
        ...
        function UrlFilterSettingVM() {
            var self = this;
            var info = service.getUrlFilterList_1();
            var columnsTmpl = [
            ...
            self.addRule = function () {
                ...
                showLoading();
                var params = {
                    goformId: "URL_FILTER_ADD_1",
                    addURLFilter: $("#addURLFilter").val(),
                    CSRFToken: self.CSRFToken
                };
                service.addUrlFilterRule_1(params, self.callback);
            };
            /**
             * 删除规则
             * @method deleteRule
            ...
            self.deleteRule = function () {
                showConfirm('confirm_data_delete', function () {
                    showLoading();
                    var params = {
                        goformId: "URL_FILTER_DELETE_1",
                        url_filter_delete_id: self.gridTemplate.selectedIds().join(";") + ";",
                        CSRFToken: self.CSRFToken
                    };
                    service.deleteSelectedRules_1(params, self.callback);
                });
            }
        }
