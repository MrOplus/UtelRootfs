...
define([ 'jquery', 'knockout', 'config/config', 'service'],
	...
	var originfrmLan="";
        function LanVM() {
            ...
            self.ipAddress2 = ko.observable(info.va0_ipaddr);
            ...
            self.dhcpDns = ko.observable(info.dhcpDns);
            ...
            if(service.getAllOnceDatas().tz_multidhcp_enable != "0"){
            ...
            $("#txtIpAddress").on("blur",function(){
               ...
               var dhcpDnsLangth1= dhcpDns.replace(dhcpDns,ipAddress);
