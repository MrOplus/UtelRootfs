    ...
    function ($, ko, config, service, _) {
        ...
        function passwordModel() {
            ...
            self.changePassword = function () {
                ...
                if(self.newUsername() == getGuestUserPass.guest_user){
                    showAlert("new_username_exist");
                    return false;
                }
                if(self.newPassword() == getGuestUserPass.guest_Password){
                    showAlert("new_password_exist");
                    return false;
                }
                var para = {
